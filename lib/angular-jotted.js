(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jotted"), require("marked"), require("codemirror"), require("angular-ui-bootstrap"), require("angular-marked"));
	else if(typeof define === 'function' && define.amd)
		define("angular-jotted", ["jotted", "marked", "codemirror", "angular-ui-bootstrap", "angular-marked"], factory);
	else if(typeof exports === 'object')
		exports["angular-jotted"] = factory(require("jotted"), require("marked"), require("codemirror"), require("angular-ui-bootstrap"), require("angular-marked"));
	else
		root["angular-jotted"] = factory(root["jotted"], root["marked"], root["codemirror"], root["angular-ui-bootstrap"], root["angular-marked"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_27__, __WEBPACK_EXTERNAL_MODULE_28__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jottedDir = __webpack_require__(1);
	
	var _jottedDir2 = _interopRequireDefault(_jottedDir);
	
	var _jottedService = __webpack_require__(26);
	
	var _jottedService2 = _interopRequireDefault(_jottedService);
	
	var _angularUiBootstrap = __webpack_require__(27);
	
	var _angularUiBootstrap2 = _interopRequireDefault(_angularUiBootstrap);
	
	var _angularMarked = __webpack_require__(28);
	...
	// index.js
	exports.default = angular.module('aw-jotted', [_angularUiBootstrap2.default, _angularMarked2.default]).directive('jotted', _jottedDir2.default).service('jottedService', _jottedService2.default.jottedServiceFactory).service('jottedMinErr', function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // jottedDir.js
	
	
	var _jotted = __webpack_require__(2);
	...
	var _jottedConfig = __webpack_require__(21);
	
	var _jottedConfig2 = _interopRequireDefault(_jottedConfig);
	...
	var JottedDir = function () {
	    function JottedDir($window, $uibModal, marked, jottedMinErr, jottedService) {
	        _classCallCheck(this, JottedDir);
	
	        // console.log('test', CodeMirror, window.CodeMirror);
	        $window.Marked = _marked2.default; // global for jotted
	        $window.CodeMirror = _codemirror2.default; // dito
	        ...
	        this.config = this.config || angular.copy(_jottedConfig2.default);
	
	        this.controller = function () {}; // later controller for handling clicks etc.
	        this.controllerAs = 'jottedCtrl';
	    }
	
	    _createClass(JottedDir, [{
	        key: 'link',
	        value: function link(scope, element, attrs, ctrl) {
	            // console.log('jotted config', ctrl, JottedDir.instance.config);
	            var self = JottedDir.instance;
	            var config = angular.merge(ctrl.config, JottedDir.instance.config);
	            ...
	            var jotted = self.jottedService.createInst(config);
	            console.log(jotted);
	        ...
	        value: function showHelp() {
	            this.$uibModal.open({
	                template: '<div class="modal-header">' + '<h3 class="modal-title">Help</h3>' + '</div><div class="modal-body">' + this.marked(__webpack_require__(25)) + '</div>' + '<div class="modal-footer">' + '<button class="btn btn-primary" type="button" ng-click="helpModalCtrl.cancel()">Close</button>' + '</div>',
	        ...
	        value: function directiveFactory($window, $uibModal, marked, jottedMinErr, jottedService) {
	            'ngInject';
	...
	exports.default = JottedDir.directiveFactory;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(mod) {
	  if (true) // CommonJS
	    mod(__webpack_require__(14), __webpack_require__(19), __webpack_require__(17), __webpack_require__(18));
	  else if (typeof define == "function" && define.amd) // AMD
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // jottedService.js
	...
	var JottedService = function () {
	    function JottedService($http) {
	        'ngInject';
	
	        _classCallCheck(this, JottedService);
	    ...
	    _createClass(JottedService, [{
	        key: 'createInst',
	        value: function createInst(config) {
	            this.config = config;
	            this.jotted = new _jotted2.default(document.querySelector('#jotted-editor'), this.config);
	        ...
	        value: function update(config) {
	            ...
	            setTimeout(function () {
	                for (var i = 0; i < _this.config.files.length; i++) {
	                    _this.jotted.trigger('change', angular.copy(_this.config.files[i])); //this.config.files);
	                }
	            }, 0);
	        }
	    }, {
	        key: 'loadGist',
	        value: function loadGist(id) {
	        ...
	        key: 'jottedServiceFactory',
	        value: function jottedServiceFactory($http) {
	            'ngInject';
	    ...
	    return JottedService;
	}();
	
	exports.default = JottedService;
	module.exports = exports['default'];
...
;
//# sourceMappingURL=angular-jotted.js.map